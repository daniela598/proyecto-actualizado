...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-01-2022 a las 03:50:24
...
CREATE TABLE `rool` (
  `usuarios` int(15) NOT NULL,
  `administrador` int(15) NOT NULL,
...
INSERT INTO `usuarios` (`id`, `nombre`, `usuario`, `email`, `contrasena`) VALUES
(7, 'mateo', 'mateolopez', 'mateolopez@gmail.com', '2339903'),
(8, 'daniela', 'daniela67', 'daniela67@gmail.com', '3012996705'),
(9, 'katerine', 'ycberrio', 'kate456@gmail.com', 'katerine123');
...
--
ALTER TABLE `administrador`
  ADD CONSTRAINT `administrador_ibfk_1` FOREIGN KEY (`id_admin`) REFERENCES `usuario_has_sistema` (`usuarios`);
COMMIT;
